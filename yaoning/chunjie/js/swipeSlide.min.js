...
;(function(win,$){
    ...
    function fnSlide(me, go, num, e){
        ...
        if(go === 'end'){
            me.opts.endCallback(me._index,me._liLength, e);
        }else if(arguments[1] !== ''){
            me.opts.callback(me._index,me._liLength, e);
        }
    }
